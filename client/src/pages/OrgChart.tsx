...
const orgData = {
  managers: [
    { id: "m1", name: "Sarah Miller", role: "Regional Manager", avatar: avatar2, color: "bg-blue-50 border-blue-200" },
    { id: "m2", name: "Robert Stone", role: "Territory Manager", avatar: null, color: "bg-blue-50 border-blue-200" },
  ],
  insideReps: [
    { id: "ir1", name: "Alex Johnson", role: "Inside Sales Lead", avatar: avatar1, manager: "m1", supports: ["fr1", "fr2"], color: "bg-purple-50 border-purple-200" },
    { id: "ir2", name: "Sam Wilson", role: "Inside Sales", avatar: null, manager: "m1", supports: ["fr3"], color: "bg-purple-50 border-purple-200" },
    { id: "ir3", name: "Emily Davis", role: "Inside Sales", avatar: null, manager: "m2", supports: ["fr4", "fr5"], color: "bg-purple-50 border-purple-200" },
  ],
  fieldReps: [
    { id: "fr1", name: "Mike Field", role: "Field Sales", territory: "North Seattle", avatar: null, color: "bg-green-50 border-green-200" },
    { id: "fr2", name: "Jessica Wong", role: "Field Sales", territory: "Bellevue", avatar: null, color: "bg-green-50 border-green-200" },
    { id: "fr3", name: "David Kim", role: "Field Sales", territory: "Downtown", avatar: null, color: "bg-green-50 border-green-200" },
    { id: "fr4", name: "Lisa Patel", role: "Field Sales", territory: "South Seattle", avatar: null, color: "bg-green-50 border-green-200" },
    { id: "fr5", name: "Tom Wilson", role: "Field Sales", territory: "Tacoma", avatar: null, color: "bg-green-50 border-green-200" },
  ]
};
    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative bg-muted/30">
        <header className="h-16 border-b border-border flex items-center justify-between px-6 bg-card z-10">
          <h1 className="text-xl font-heading font-semibold text-foreground">Organization Chart</h1>
        ...
        <div className="flex-1 overflow-hidden relative p-8">
           ...
           <div className="absolute bottom-8 right-8 flex flex-col gap-2 z-20">
              <Button variant="secondary" size="icon" onClick={() => setZoom(z => Math.min(z + 0.1, 1.5))}>
                 <ZoomIn className="h-4 w-4" />
              </Button>
              <Button variant="secondary" size="icon" onClick={() => setZoom(z => Math.max(z - 0.1, 0.5))}>
