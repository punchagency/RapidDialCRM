...
export default function Dashboard() {
            ...
            <div className="relative z-10 p-6 h-full flex flex-col justify-between pointer-events-none">
              ...
              <div className="bg-white/90 backdrop-blur p-4 rounded-xl shadow-lg border border-gray-100 w-full max-w-md pointer-events-auto">
                <h3 className="font-bold text-gray-900 mb-1">
                  Current Stop: Swedish Medical Center
                </h3>
  ...
  const getPerformanceBadge = (index: number) => {
    if (index === 0)
      return <Badge className="bg-yellow-500">Top Performer</Badge>;
    if (index === 1)
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        index % 2 === 0
                          ...
                          : "bg-white hover:bg-gray-50 border-y border-gray-100"
                      )}
                    >
            ...
            <div className="flex gap-3 items-start p-3 border border-red-100 bg-red-50 rounded-lg">
              ...
              <div>
                <p className="text-sm font-semibold text-red-900">
                  Missed Target: North Territory
                </p>
                <p className="text-xs text-red-700">
                  Visits down 20% this week.
                </p>
              </div>
            </div>
            <div className="flex gap-3 items-start p-3 border border-yellow-100 bg-yellow-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-yellow-700">
                  Quarterly review for West Coast team.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        ...
        <Card className="bg-white shadow-sm border-none">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-500 mb-4">
              {prospects.length.toLocaleString()} Leads
            </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-gray-900">
                    Q3_Leads_Batch_{i}.csv
                  </p>
                  <p className="text-xs text-gray-500">
                    Imported 2 hours ago • 450 records
                  </p>
                </div>
              </div>
      ...
      <Dialog open={isBulkSearchOpen} onOpenChange={setIsBulkSearchOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Find professionals by specialty and location, then add them to
              your database.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                value={bulkSearchSpecialty}
                onChange={(e) => setBulkSearchSpecialty(e.target.value)}
              />
            </div>
            <div>
              ...
              <Input
                ...
                value={bulkSearchLocation}
                onChange={(e) => setBulkSearchLocation(e.target.value)}
              />
            </div>
            <div>
              ...
              <Input
                ...
                value={bulkSearchTerritory}
                onChange={(e) => setBulkSearchTerritory(e.target.value)}
              />
            </div>
            <Button
